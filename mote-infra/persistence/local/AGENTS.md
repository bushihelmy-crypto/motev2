# Mote Local Infrastructure Persistence engineering rules

## Architecture

- This project is the local persistence implementation under `mote-infra/persistence`. The durable, protocol, and persistenced directories are a provisional exploration, not settled package boundaries.
