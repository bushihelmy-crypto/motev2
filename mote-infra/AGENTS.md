...
- `mote-container` is a separate hosting boundary. It may expose platform capabilities and inject a configured Port resolver before starting Kernel, but it must not own persistence or RPC semantics.
