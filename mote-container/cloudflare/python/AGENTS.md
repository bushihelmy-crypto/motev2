...
- If selected, raw Cloudflare SQL, schema, and transaction code belong to `mote-persistence/cloudflare/python`, not this Container project. Do not call the Durable Object SQL API here.
