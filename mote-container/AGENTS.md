...
- Concrete persistence and transaction mechanisms belong to `mote-infra/persistence`; Container code must not own SQL schemas, transaction code, backend-specific state semantics, or persistence-backend selection.
