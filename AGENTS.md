...
- Preserve strict owner boundaries: Python owns Agent flow semantics, Go owns control-plane mechanisms, Rust owns execution and state mechanisms, and `conformance/` owns shared observable contracts.
