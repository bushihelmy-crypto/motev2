...
- This project starts as one Rust package. The durable, protocol, and persistenced directories are a provisional exploration, not settled package boundaries.
...
- If retained, persistenced is a candidate composition boundary for configuration, listeners, telemetry, and graceful shutdown rather than state and transaction rules.
