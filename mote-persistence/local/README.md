...
Mote Local Persistence is the Rust implementation of Mote's reliability substrate for local and host-native deployments. It will provide durable state, atomic commit, operation receipts, coordination, reliable execution attempts, workspace state, and storage adapters without interpreting Agent flow semantics.
