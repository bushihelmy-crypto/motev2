...
This project is the TypeScript Cloudflare Durable Object persistence implementation for Mote. It owns concrete `storage.sql`, schema, serialization, migration, and transaction behavior.
