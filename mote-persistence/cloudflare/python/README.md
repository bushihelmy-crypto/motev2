...
This project is the Cloudflare Durable Object SQLite persistence Adapter for Mote. It owns the concrete SQL, schema, serialization, migration, and transaction implementation behind Kernel persistence Ports.
