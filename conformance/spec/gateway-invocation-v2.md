...
This document defines `gateway_invocation` version `2`, the service- and protocol-neutral
model boundary used by the runtimes. The JSON Schema in
[`schemas/protocol/gateway_invocation.v2.schema.json`](../schemas/protocol/gateway_invocation.v2.schema.json)
...
Version 2 has two caller-owned profiles. They deliberately use different DTOs:
...
The operation/modality/input combinations fixed by v2 are:
